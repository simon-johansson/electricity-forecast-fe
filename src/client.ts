// Code generated by the Encore v1.14.0 client generator. DO NOT EDIT.
...
export namespace forecast {
    ...
    export class ServiceClient {
        ...
        public async GetForecasts(): Promise<ListResponse> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        this.headers = {
            ...
            "User-Agent":   "electricity-forecast-k4k2-Generated-TS-Client (Encore/v1.14.0)",
        }
