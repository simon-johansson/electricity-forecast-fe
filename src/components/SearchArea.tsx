      ...
      <svg className="h-[400px]" fill="none" viewBox="0 0 41.910002 103.12752">
        <g>
          <path
            ...
            // fill="#C4EBDB"
            fill={selectedRegion === "SE01" ? "#4ade80" : "#94a3b8"}
            onClick={() => {
          ...
          <path
            ...
            // fill="#84D7B5"
            fill={selectedRegion === "SE02" ? "#4ade80" : "#cbd5e1"}
            onClick={() => {
          ...
          <path
            ...
            // fill="#00BA7D"
            fill={selectedRegion === "SE03" ? "#4ade80" : "#94a3b8"}
            onClick={() => {
          ...
          <path
            ...
            // fill="#009B63"
            fill={selectedRegion === "SE04" ? "#4ade80" : "#cbd5e1"}
            onClick={() => {
