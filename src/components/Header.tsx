...
const Header: FC = () => {
  return (
    <header
      className="h-[500px] bg-cover bg-local bg-center bg-no-repeat [mask-image:linear-gradient(to_bottom,white_70%,transparent)] lg:bg-[center_top_-100px]"
      style={{ backgroundImage: "url(/assets/header-bg.jpg)" }}
    >
      <nav className="h-full">
        <div className="relative z-50 mx-auto flex h-full max-w-4xl flex-col px-4 py-8">
          ...
          {/*<div className="mb-24 flex h-full w-full items-center lg:w-[800px]">*/}
          <div className="flex h-full w-full items-center">
            <div className="h-fit w-full rounded-lg bg-white bg-opacity-80 py-6 px-8">
              <h1 className="mb-6 text-2xl font-semibold leading-8 md:text-4xl">
                Energy Price Forecasts
              </h1>
              <p className="text-base md:text-xl">
                Plan for price spikes, adapt your consumption & save money. Five day forecasts, for
                all of Europe.
              </p>
              <a href="/#forecasts">
                <button className="mt-8 rounded-md bg-indigo-600 px-3 py-2 text-center font-semibold text-white">
                  Go to forecasts
                </button>
              </a>
            </div>
    ...
    <>
      {[
        ...
        <a
          key={label}
          href={href}
          className="relative px-3 py-2 text-sm text-gray-700 hover:text-black"
          onMouseEnter={() => {
